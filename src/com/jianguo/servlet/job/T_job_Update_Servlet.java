...
//		String job_model =request.getParameter("job_model");
		...
		if(only.equals(ss_only) || only.equals(ss_only2) || only.equals(ss_only3)){
			...
			int i = T_job_Sql.update_all(city_id,aera_id,type_id, merchant_id, name, name_image, ss, sss, address, mode,money, term, limit_sex, sum, ly_time, "0","1",alike,"1","0",ss2,job_id);
